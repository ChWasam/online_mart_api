...
# from app import settings, notification_pb2,db, kafka,auth
...
#             elif new_msg.option == notification_pb2.SelectOption.LOGIN:
#                 await handle_login(new_msg)
#             elif new_msg.option == notification_pb2.SelectOption.CURRENT_USER:
#                 await handle_verify_user(new_msg)
#             elif new_msg.option == notification_pb2.SelectOption.REFRESH_TOKEN:
